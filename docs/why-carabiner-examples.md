...
```typescript
import { createHook } from '@carabiner/hooks-core';
import { TestRunner } from '@carabiner/testing';
...
// A future @carabiner/build module could provide
...
```typescript
import { createHook } from '@carabiner/hooks-core';
import { CodeOrganizer } from '@carabiner/code';
...
```typescript
import { createHook } from '@carabiner/hooks-core';
import { CodeAnalyzer, Suggestion } from '@carabiner/analysis';
...
```typescript
import { createHook } from '@carabiner/hooks-core';
import { GitHubClient } from '@carabiner/github';
import { LinearClient } from '@carabiner/linear';
